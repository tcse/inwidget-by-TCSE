...
* loginAvailable - если вы хотите выводить разные логины на разных страницах сайта, добавьте в этот массив список логинов, которые разрешенны к показу. Затем вы сможете передавать необходимый логин в виджет с помощью GET переменной. Например: /inwidget/index.php?login=fotokto_ru
* tagsAvailable - если вы хотите выводить разные теги на разных страницах сайта, добавьте в этот массив список тегов, которые разрешены к показу. Затем вы сможете передавать необходимый тег в виджет с помощью GET переменной. Например: /inwidget/index.php?tag=photography. Данную настройку можно комбинировать с "loginAvailable" и "tagsFromAccountOnly".
...
Посмотреть демонстрацию работы адаптивного режима: https://inwidget.ru/adaptive.php
...
* Изменен алгоритм получения данных об аккаунте пользователя

inWidget-1.3.1
Дата: 05 февраля 2019 г.

* Добавлена возможность передавать необходимый логин через GET-переменную (см. настройку loginAvailable)
* Добавлена возможность передавать необходимый тег через GET-переменную (см. настройку tagsAvailable)
* В совокупности обе настройки (loginAvailable и tagsAvailable) позволят вам легко выводить разный контент в виджете на разных страницах вашего сайта.
* Исправлена ошибка при работе с несколькими аккаунтами и включённой опцией tagsFromAccountOnly, которая приводила к перезаписи кэша.
...
* Улучшена отказоустойчивость при использовании недокументированного API

inWidget-1.2.7
Дата: 14 апреля 2018 г.

* Официальное endpoint API снова работает. Нужно лишь заново сгенерировать ACCESS_TOKEN по ссылке из инструкции.

inWidget-1.2.6
Дата: 14 апреля 2018 г.

* Теперь при ошибке будет отдаваться старая версия кэша. Внизу виджета начнёт выводиться предупреждение.
* Добавлена авторизация в Instagram по логину и паролю при использовании недокументированного API. Авторизация необходима для пагинации и альтернативных способов получения данных.
* Обновлена библиотека instagram-php-scraper до версии v0.8.18
* Внесено множество изменений в библиотеку instagram-php-scraper

inWidget-1.2.5
Дата: 07 апреля 2018 г.

* Откат изменений к версии 1.2.1 в связи с тем, что узел (/graphql/query/?query_id=) перестал работать
* Добавление изменений из версии 1.2.3
...
* Начиная с 04 апреля 2018 г. официальное Endpoint API более не актуально. Указание ACCESS_TOKEN в настройках не имеет смысла.

inWidget-1.2.4
Дата: 27 марта 2018 г.

* Исправлена ошибка, из-за которой перестали выводиться фотографии по тегам при использовании недокументированного API.

inWidget-1.2.3
Дата: 23 марта 2018 г.

* Исправлена ошибка, из-за которой перестали выводиться новые фотографии при использовании недокументированного API. Связана была с тем, что у Instagram изменился CDN-сервер, а в библиотеке instagram-php-scraper жёстко был прописан адрес домена.
...
Посетите сайт виджета: https://inwidget.ru
...
Все способы пожертвований доступны по этой ссылке: https://inwidget.ru/donate.php
А также на главной странице сайта https://inwidget.ru/
